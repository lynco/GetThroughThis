...
var MapsLib = {
  ...
  submitSearch: function(whereClause, map, location) {
    ...
    MapsLib.currentWhereClause = whereClause;
  ...
  displayList: function(json) {
    if (MapsLib.currentWhereClause.indexOf('ST_') == -1) {
	results_title = "All Organizations: Within " + (MapsLib.searchRadius/1610).toFixed(2) + " miles";
    } else {
	results_title = "Search Results: Within " + (MapsLib.searchRadius/1610).toFixed(2) + " miles";
    }	
