...
var MapsLib = {
  ...
  fusionTableId:      "1FboyadzqD6n9vhAtXtjGinEAXzKkzWEazfcC8L7g",

  //*New Fusion Tables Requirement* API key. found at https://code.google.com/apis/console/
  //*Important* this key is for demonstration purposes. please register your own.
  googleApiKey:       "AIzaSyD-rPTjb8GVcEguMIvOSdiqmffmgMUft_A",
  ...
  map_centroid:       new google.maps.LatLng(37.68728, -122.279205), //center that your map defaults to
  ...
  doSearch: function(location) {
    MapsLib.clearSearch();
    MapsLib.searchQuerySupplied=false;
  ...
  getList: function(whereClause) {
    var selectColumns = "org_name";
    MapsLib.query(selectColumns, whereClause, "", "", "MapsLib.displayList");
  },

  displayList: function(json) {
      var list_title_word = MapsLib.recordName.charAt(0).toUpperCase() + MapsLib.recordName.slice(1);
    if (MapsLib.searchQuerySupplied == false) {
	results_title = "All " + list_title_word + ": Within " + (MapsLib.searchRadius/1610).toFixed(2) + " miles";
    } else {
	results_title = list_title_word + " in Search: Within " + (MapsLib.searchRadius/1610).toFixed(2) + " miles";
    }	
    ...
    if (data == null) {
      ...
      template = "<div class='search-results-title'>" + results_title + "</div>"
